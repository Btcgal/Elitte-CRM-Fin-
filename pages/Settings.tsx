...
const SecuritySettings = () => (
    <Card>
        ...
        <div className="p-6">
            <div className="mt-6 grid grid-cols-12 gap-6">
                <div className="col-span-12 sm:col-span-6">
                    <label htmlFor="current-password" aclassName="block text-sm font-medium text-gray-700">Senha Atual</label>
                ...
                <div className="col-span-12 sm:col-span-6">
                    <label htmlFor="new-password" aclassName="block text-sm font-medium text-gray-700">Nova Senha</label>
                ...
                <div className="col-span-12 sm:col-span-6">
                    <label htmlFor="confirm-password" aclassName="block text-sm font-medium text-gray-700">Confirmar Nova Senha</label>
